...
- **The selector is sized to its labels, not stretched across the card.** Full width, two chips read as two large buttons — the card's main event — when what they are is a pair of tabs over one body. They stay chips rather than becoming underlined links: a tab that looks like a section heading is a tab nobody presses, and this app's section headings are exactly that shape.
