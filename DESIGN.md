...
- **Today's ring is Aqua Glaciar, and the birthday cake is why.** It was a Steel Frost hairline, which held the cake down to 22dp — big enough to clear the ring, too small to be recognised as a cake at all. Two concentric grey circles crossing each other is a scribble; two shapes in different hues crossing each other is two shapes. So the ring took the hue and the cake took the size (32dp, spanning 8 to 40 across a 48dp cell, clear of the corner marks at 10). The secondary accent also happens to make today **visible**, which the hairline barely was — and it completes the chip vocabulary rather than breaking it: the accent fills what is chosen, the accent outlines what is today. The primary stays on actions.
